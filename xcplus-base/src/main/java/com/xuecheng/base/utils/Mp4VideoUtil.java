...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "D:\\Codes\\learning\\资料\\学成在线项目-资料\\day06 文件预览 视频处理 XXL-JOB\\资料\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "D:\\Codes\\learning\\资料\\学成在线项目-资料\\day06 文件预览 视频处理 XXL-JOB\\资料\\测试视频\\02-概述-分库分表是什么(1).avi";
    String mp4_name = "02-概述-分库分表是什么(1).mp4";
    String mp4folder_path = "D:\\Codes\\learning\\资料\\学成在线项目-资料\\day06 文件预览 视频处理 XXL-JOB\\资料\\测试视频";
    public Mp4VideoUtil(String video_path, String mp4_name, String mp4folder_path){
        super();
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String video_path = "D:\\Codes\\learning\\资料\\学成在线项目-资料\\day06 文件预览 视频处理 XXL-JOB\\资料\\测试视频\\02-概述-分库分表是什么(1).avi";
        String mp4_name = "02-概述-分库分表是什么(1).mp4";
        String mp4_path = "D:\\Codes\\learning\\资料\\学成在线项目-资料\\day06 文件预览 视频处理 XXL-JOB\\资料\\测试视频\\02-概述-分库分表是什么(1).mp4";
        //创建工具类对象
        Mp4VideoUtil videoUtil = new Mp4VideoUtil(video_path,mp4_name,mp4_path);
        //开始视频转换，成功将返回success
